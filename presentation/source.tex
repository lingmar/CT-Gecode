...
\begin{frame}
  ...
  \small
  \only<1-5>{
    $s(x_0) = s(x_1) = s(x_2) = \Set{1,2,3,4}$
  }
  \only<6->{
    $s(x_0) = \Set{1,2,4}$\\
    $s(x_1) = s(x_2) = \Set{1,2,3,4}$
  }
  ...
  \begin{tabular}{l}
    ...
    \begin{tabular}{|cccccccc|}
      \hline
      % \phantom{$x_0$} & 0 & \textbf{1} & \textbf{1} & \textbf{1} & 0 & 0 & \textbf{1} & \textbf{1} & 0 & 0 & \textbf{1} & 0 & \textbf{1} & 0 & 0 & \textbf{1} \\
      {1} & {1} & {1} & {1} & {1}& {1}& {1} & {1} \\
      \hline
    \end{tabular}
    \bigskip
    ...
    \\
    \small
    \alt<5->{\color{red}$\Tuple{x_0,3}$}{$\Tuple{x_0,3}$}    
    \begin{tabular}{|cccccccc|}
      % \phantom{$x_0$} & 0 & \textbf{1} & \textbf{1} & \textbf{1} & 0 & 0 & \textbf{1} & \textbf{1} & 0 & 0 & \textbf{1} & 0 & \textbf{1} & 0 & 0 & \textbf{1} \\
      \alt<5->{{\color{red}0} & \color{red}0 & \color{red}0 & \color{red}0 & \color{red}0 & \color{red}0 & \color{red}0 & {\color{red}0}} 
              {0 & 0 & 0 & 0 & 0 & 0 & 0 & 0} \\
    \end{tabular}
    \\
    \small
    ...
    \\
    \small
    $\quad \ldots \qquad \qquad \qquad \quad \ \ldots$
    \\
    \small
    $\Tuple{x_2,4}$
    \begin{tabular}{|cccccccc|}
    ...
    \begin{tabular}{|c|ccccccccccccccc|}
      \hline
      $x_0$ & 7 & \textbf{2} & \textbf{1} & \textbf{2} & 6 & 7 & \textbf{4} & \textbf{1} & 7 & 8 & \textbf{2} & 0 & \textbf{2} & 5 & \textbf{4} \\
...
\begin{frame}
  ...
  $s(x_0) = \Set{1,2,4}$\\
  $s(x_1) = \Set{\cancel{1},\cancel{2},3,4}$\\
  $s(x_2) = \Set{1,2,3,4}$

\end{frame}

\begin{frame}
  \frametitle{Procedure for updating \CurrTable}
  \begin{algorithm}[H]
    \small
    \begin{algorithmic}[1]
...
\begin{frame}
  ...
  \begin{tabular}{c}
    ...
    \begin{tabular}{cc}
      $\Tuple{x_2,1}$
        & 
          \begin{tabular}{|cccccccc|}
            \hline
            \alt<2->{\color{green}0 & \color{green}0 & \color{green}0 & \color{green}1 & \color{green}1 & \color{green}0 & \color{green}1 & \color{green}1}
            {0 & 0 & 0 & 1 & 1 & 0 & 1 & 1} \\
          \end{tabular}
        \\
        $\Tuple{x_2,2}$
        & 
          \begin{tabular}{|cccccccc|}
            \alt<2->
            {\color{green}0 & \color{green}1 & \color{green}1 & \color{green}0 & \color{green}0 & \color{green}0 & \color{green}0 & \color{green}0}
            {0 & 1 & 1 & 0 & 0 & 0 & 0 & 0} \\
          \end{tabular}
        \\
        $\Tuple{x_2,3}$
        & 
          \begin{tabular}{|cccccccc|}
            \alt<2->
            {\color{red}0 & \color{red}0 & \color{red}0 & \color{red}0 & \color{red}0 & \color{red}1 & \color{red}0 & \color{red}0}
            {0 & 0 & 0 & 0 & 0 & 1 & 0 & 0} \\
          \end{tabular}
        \\
        $\Tuple{x_2,4}$
        & 
          \begin{tabular}{|cccccccc|}
            \alt<2->
            {\color{red}1 & \color{red}0 & \color{red}0 & \color{red}0 & \color{red}0 & \color{red}0 & \color{red}0 & \color{red}0} 
            {1 & 0 & 0 & 0 & 0 & 0 & 0 & 0} \\
            \hline
          \end{tabular}
      \\
    ...
    \phantom{foo} \\
    \alt<2>    
    {$s(x_2) = \Set{1,2,\cancel{3},\cancel{4}}$}
    {$s(x_2) = \Set{1,2,3,4}$}
    \end{tabular}
  ...
  \begin{algorithm}[H]
    ...
    \begin{algorithmic}[1]
      ...
      \FOREACH{$x \in s \text{~such that~} |s(x)| > 1$}
            \FOREACH{$a \in s(x)$}
              \STATE $\localvar{inde x} \leftarrow \Residues[x,a]$
