...
\begin{frame}
  ...
  \begin{tabular}{l}
    ...
    \begin{tabular}{|c|cccccccccccccccc|}
      \hline
      $x_0$ & 7 & 2 & 1 & 2 & 6 & 7 & 4 & 1 & 7 & 8 & 2 & 0 & 3 & 5 & 4 \\
    ...
    \begin{tabular}{|c|ccccccccccccccc|}
      \hline
      $x_0$ & 7 & \textbf{2} & \textbf{1} & \textbf{2} & 6 & 7 & \textbf{4} & \textbf{1} & 7 & 8 & \textbf{2} & 0 & \textbf{3} & 5 & \textbf{4} \\
    ...
    \begin{tabular}{|c|cccccccc|}
      \hline
      $x_0$ & \textbf{2}& \textbf{1} & \textbf{2} & \textbf{4} & \textbf{1} & \textbf{2} & \textbf{3} & \textbf{4} \\
