...
\begin{frame}
  ...
  \begin{minipage}{0.5\textwidth}
    ...
    \only<2>{$x_0 \in \Set{\cancel{\color{red}1},\cancel{\color{red}2},\cancel{\color{red}3},\cancel{\color{red}4},\cancel{\color{red}5},\cancel{\color{red}6},7,\cancel{\color{red}8},9}$}
    \only<3->{$x_0 \in \Set{\cancel{\color{red}1},\cancel{\color{red}2},\cancel{\color{red}3},\cancel{\color{red}4},\cancel{\color{red}5},\cancel{\color{red}6},\textbf{7},\cancel{\color{red}8},\cancel{\color{red}9}}$} \\
    \only<1>{$x_1 \in \Set{1,2,3,4,5,6,7,8,9}$}
    \only<2-3>{$x_1 \in \Set{\cancel{\color{red}1},\cancel{\color{red}2},\cancel{\color{red}3},\cancel{\color{red}4},\cancel{\color{red}5},\cancel{\color{red}6},7,\cancel{\color{red}8},9}$}
    \only<4->{$x_1 \in \Set{\cancel{\color{red}1},\cancel{\color{red}2},\cancel{\color{red}3},\cancel{\color{red}4},\cancel{\color{red}5},\cancel{\color{red}6},\cancel{\color{red}7},\cancel{\color{red}8},\textbf{9}}$}\\
    $\ldots$ \\
    \only<1-2>{$x_4 \in \Set{1,2,3,4,5,6,7,8,9}$}
    \only<3->{$x_4 \in \Set{\cancel{\color{red}1},\textbf{2},\cancel{\color{red}3},\cancel{\color{red}4},\cancel{\color{red}5},\cancel{\color{red}6},\cancel{\color{red}7},\cancel{\color{red}8},\cancel{\color{red}9}}$}\\
    $\ldots$
    %$\Table(\Set{x_0,x_1},\Set{\Tuple{7,9},\Tuple{9,7}})$
...
\begin{frame}
  ...
  \begin{algorithm}[H]
    ...
    \begin{algorithmic}[1]
      ...
      \FOREACH{variable $x \in s \text{~such that~} |s(x)| > 1$}
            \FOREACH{value $a \in s(x)$}
...
\begin{frame}
  ...
  \begin{tabular}{cc}
      \begin{tikzpicture}[scale=0.5]
        \input{../report/aim-50-pos-run.tex}
      \end{tikzpicture} 
    &
    \begin{tikzpicture}[scale=0.5]
      \input{../report/aim-100-pos-run.tex}
    \end{tikzpicture} \\
    
    \begin{tikzpicture}[scale=0.5]
      \input{../report/aim-200-pos-run.tex}
    \end{tikzpicture} & \\
  \end{tabular}
\end{frame}
...
\begin{frame}
  ...
  \begin{tabular}{cc}
    \begin{tikzpicture}[scale=0.5]
      \input{../report/dubois-run.tex}
    \end{tikzpicture}
    &
      \begin{tikzpicture}[scale=0.5]
        \input{../report/geom-run.tex}
      \end{tikzpicture} \\
  \end{tabular}
\end{frame}
...
\begin{frame}
  ...
  \begin{tabular}{cc}
    \begin{tikzpicture}[scale=0.5]
      \input{../report/k5_n10_d10_m15_p08-run.tex}
    \end{tikzpicture}
    &
      \begin{tikzpicture}[scale=0.5]
        \input{../report/a5-run.tex}
      \end{tikzpicture} \\
    \begin{tikzpicture}[scale=0.5]
      \input{../report/a10-run.tex}
    \end{tikzpicture}
    &
      \begin{tikzpicture}[scale=0.5]
        \input{../report/mdd05-run.tex}
      \end{tikzpicture} \\
  \end{tabular}
\end{frame}
...
\begin{frame}
  ...
  \begin{tabular}{cc}
    \begin{tikzpicture}[scale=0.5]
      \input{../report/randsJC2500-run.tex}
    \end{tikzpicture}
    &
      \begin{tikzpicture}[scale=0.5]
        \input{../report/randsJC5000-run.tex}
      \end{tikzpicture} \\
    \begin{tikzpicture}[scale=0.5]
      \input{../report/randsJC7500-run.tex}
    \end{tikzpicture}
    &
      \begin{tikzpicture}[scale=0.5]
        \input{../report/randsJC10000-run.tex}
      \end{tikzpicture} \\
  \end{tabular}
\end{frame}
...
\begin{frame}
  ...
  \begin{tabular}{cc}
    \begin{tikzpicture}[scale=0.5]
      \input{../report/langford4-run.tex}
    \end{tikzpicture}
    &
      \begin{tikzpicture}[scale=0.5]
        \input{../report/dubois-run.tex}
      \end{tikzpicture} \\
    \begin{tikzpicture}[scale=0.5]
      \input{../report/pigeonsplus-run.tex}
    \end{tikzpicture}
    &
      \begin{tikzpicture}[scale=0.5]
        \input{../report/TSP_Quat_20-run.tex}
      \end{tikzpicture} \\
  \end{tabular}
\end{frame}
...
\begin{frame}
  ...
  \begin{tabular}{cc}
    \begin{tikzpicture}[scale=0.5]
      \input{../report/bddLarge-run.tex}
    \end{tikzpicture}
    &
      \begin{tikzpicture}[scale=0.5]
        \input{../report/Crosswords_lexVg-run.tex}
      \end{tikzpicture} \\
    \begin{tikzpicture}[scale=0.5]
      \input{../report/a5-run.tex}
    \end{tikzpicture}
...
\begin{frame}
  ...
  \begin{tabular}{cc}
    \begin{tikzpicture}[scale=0.5]
      \input{../report/nonograms-run.tex}
    \end{tikzpicture}
    &
      \begin{tikzpicture}[scale=0.5]
        \input{../report/randsJC5000-run.tex}
