...
\Todo{Or skip initCT() and only count calls to propagate()?}
...
from XCSP 2.1~\cite{DBLP:journals/corr/abs-0902-2362} format 
...
\todo{By various reasons, only X instances were used}
