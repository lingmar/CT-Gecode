...
\Todo{Some more ovarall information...}

A propagator in Gecode is implemented as a C++ object inheriting from
the base class Propagator.
It must implement the following parts:
...
\begin{description}
  ...
  \item[Copying.] The propagator must implement a copy() function for cloning
    the propagator during search.
