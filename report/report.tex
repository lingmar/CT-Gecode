...
$\localvar{vars}$, that are the variables associated to the constraint~$c$,
...
the set of invalid tuples, and then reverse the temporary mask before
...
\Algoref{algo:fixDomains} shows an alternative to lines 10-11 in~\Algoref{algo:ct}.
