...
\begin{tabular}{cc}
  \begin{tikzpicture}[scale=0.9]
    \input{randsJC2500-bug.tex}
  \end{tikzpicture}
  &
  \begin{tikzpicture}[scale=0.9]
    \input{randsJC5000-bug.tex}
  \end{tikzpicture}
  \\
  \begin{tikzpicture}[scale=0.9]
    \input{langford2-bug.tex}
  \end{tikzpicture}
  &
  \begin{tikzpicture}[scale=0.9]
    \input{langford4-bug.tex}
  \end{tikzpicture}
  \\
\end{tabular}
...
\begin{tabular}{cc}
  ...
  \\
  \begin{tikzpicture}[scale=0.9]<
    \input{Crosswords_lexVg-bug.tex}
  \end{tikzpicture}
  &
  \begin{tikzpicture}[scale=0.9]
    \input{kakuroext_easy-bug.tex}
  \end{tikzpicture}
  \\
\end{tabular}
...
%    \begin{figure}
 ...
 %     \caption{\textbf{RandsJC2500.}}
  ...
  %\begin{figure}
    \begin{tikzpicture}[scale=0.9]
      \input{randsJC7500-compact.tex}
    \end{tikzpicture}
   % \caption{\textbf{A5.}}
  %\end{figure}
  &
      \begin{tikzpicture}[scale=0.9]
        \input{randsJC10000-compact.tex}
      \end{tikzpicture}
  \\
\end{tabular}
...
\begin{tabular}{cc}
  ...
  \\
  \begin{tikzpicture}[scale=0.9]
    \input{TSP_Quat_20-compact.tex}
  \end{tikzpicture}
  &
    \begin{tikzpicture}[scale=0.9]
      \input{Crosswords_lexVg-compact.tex}
    \end{tikzpicture}
  \\
\end{tabular}
...
\begin{tabular}{cc}
    ...
    \begin{tikzpicture}[scale=0.9]
      \input{Crosswords_wordsPuzzle-compact.tex}
    \end{tikzpicture}

  &
    \begin{tikzpicture}[scale=0.9]
      \input{TSP_25-compact.tex}
    \end{tikzpicture}
  ...
  \\
  \begin{tikzpicture}[scale=0.9]
    \input{aim-50-pos-compact.tex}
  \end{tikzpicture}
  &
    \begin{tikzpicture}[scale=0.9]
      \input{bddLarge-compact.tex}
    \end{tikzpicture}
  \\
\end{tabular}
...
\begin{tabular}{cc}
    ...
    \begin{tikzpicture}[scale=0.9]
      \input{kakuroext_easy-compact.tex}
    \end{tikzpicture}

  &
    \begin{tikzpicture}[scale=0.9]
      \input{k5_n10_d10_m15_p08-compact.tex}
    \end{tikzpicture}
