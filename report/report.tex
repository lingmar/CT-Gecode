...
Search continues until it reaches a leaf node, that can be either a
...
for the \Regular~constraint. The propagators are
denoted:
...
\emph{TSP 25/Quat}). 
Again, the series with low arities also have small tables, while the series
with larger arities tend to have larger tables.
